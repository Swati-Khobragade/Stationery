...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory
				.setPackagesToScan(new String[] { "com.gl.adminportal.stationery.model" });
	...
	private Properties hibernateProperties() {
		...
		properties.put(AvailableSettings.HBM2DDL_AUTO, 	environment.getRequiredProperty("hbm2ddl.auto"));
		return properties;
	}
